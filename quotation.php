...
<html lang="en">
  ...
  <body>
    <header>
      ...
      <a href="cotizacion.php" class="lang">Español <img src="images/spanish.png" width="25px" id="lan"></a>
    ...
    <section>
      ...
      <article class="article2 form">
        ...
        <p>Please always provide the engine model number, part number, serial number or the type of equipment you are requesting a quotation for.</p>
        ...
        <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" name="formulario">
          <div class="formulario">
            ...
            <p><span>Company address</span>         <input type="text" name="address"/></p>
            <p><span>City, State, Zip Code</span>   <input type="text" name="city"/></p>
            <p><span>Country</span>                 <input type="text" name="country"/></p>
            <p><span>Email address *</span>         <input type="mail" name="email" required/></p>
            <p><span>Telephone number</span>        <input type="text" name="tlf"/></p>
            <p><span>Cell phone</span>              <input type="text" name="cell"/></p>
            <p><span>Fax number</span>              <input type="text" name="fax"/></p>
            <p><span>Request for Quotation *</span> <textarea rows="5" cols="45" name="quotation" required></textarea></p>
            <p><span>Comments</span>                <textarea rows="5" cols="45" name="comment"></textarea></p>
